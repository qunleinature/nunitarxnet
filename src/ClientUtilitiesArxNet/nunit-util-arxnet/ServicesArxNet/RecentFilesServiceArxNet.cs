...
// 2013.5.29修改：
//  1.在nunit2.6.2基础上修改
//  2.NUnit.Util.RecentFilesService改为NUnit.Util.ArxNet.RecentFilesServiceArxNet类
...
namespace NUnit.Util.ArxNet
{
	...
	/// </summary>
	public class RecentFilesServiceArxNet : RecentFiles, NUnit.Core.IService
	{
		...
		#region Constructor
		public RecentFilesServiceArxNet()
			: this( ServicesArxNet.UserSettings ) { }

		public RecentFilesServiceArxNet( ISettings settings ) 
		{
