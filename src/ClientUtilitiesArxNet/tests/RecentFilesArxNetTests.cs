...
namespace NUnit.Util.ArxNet.Tests
{
	...
	/// </summary>
	[TestFixture]
	public class RecentFilesArxNetTests
	{
		static readonly int MAX = RecentFilesServiceArxNet.MaxSize;
		static readonly int MIN = RecentFilesServiceArxNet.MinSize;

		RecentFilesServiceArxNet recentFiles;
		...
		{
			Assert.AreEqual( RecentFilesServiceArxNet.DefaultSize, recentFiles.MaxFiles );
		}
