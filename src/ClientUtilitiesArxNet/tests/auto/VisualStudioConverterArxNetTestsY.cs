...
{
	[TestFixture]
	public class VisualStudioConverterArxNetTests
	{
		private VisualStudioConverterArxNet converter;
        static readonly bool useSolutionConfigs = 
            ServicesArxNet.UserSettings.GetSetting("Options.TestLoader.VisualStudio.UseSolutionConfigs", true);
		...
		{
			converter = new VisualStudioConverterArxNet();
		}
