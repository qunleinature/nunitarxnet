...
// 2013.5.30修改：
//  1.在nunit2.6.2基础上修改
//  2.NUnit.Gui.SettingsPages.TestLoaderSettingsPage改为NUnit.Gui.ArxNet.SettingsPagesArxNet.TestLoaderSettingsPageArxNet类
...
{
	public class TestLoaderSettingsPageArxNet : NUnit.UiKit.ArxNet.SettingsPageArxNet
	{
		...
		public TestLoaderSettingsPageArxNet(string key) : base(key)
		{
