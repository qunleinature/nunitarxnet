...
{
	public class TreeSettingsPageArxNet : NUnit.UiKit.ArxNet.SettingsPageArxNet
	{
		...
		public TreeSettingsPageArxNet(string key) : base(key)
		{
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(TreeSettingsPageArxNet));
