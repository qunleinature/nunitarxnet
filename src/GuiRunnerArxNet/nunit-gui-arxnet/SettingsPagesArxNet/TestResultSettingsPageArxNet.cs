...
// 2013.5.30修改：
//  1.在nunit2.6.2基础上修改
//  2.NUnit.Gui.SettingsPages.TestResultSettingsPage改为NUnit.Gui.ArxNet.SettingsPagesArxNet.TestResultSettingsPageArxNet类
...
{
	public class TestResultSettingsPageArxNet : NUnit.UiKit.ArxNet.SettingsPageArxNet
	{
		...
		public TestResultSettingsPageArxNet(string key) : base(key)
		{
