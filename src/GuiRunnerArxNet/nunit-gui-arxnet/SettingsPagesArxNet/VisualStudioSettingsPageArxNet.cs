...
// 2013.5.30修改：
//  1.在nunit2.6.2基础上修改
//  2.NUnit.Gui.SettingsPages.VisualStudioSettingsPage改为NUnit.Gui.ArxNet.SettingsPagesArxNet.VisualStudioSettingsPageArxNet类
...
{
	public class VisualStudioSettingsPageArxNet : NUnit.UiKit.ArxNet.SettingsPageArxNet
	{
		...
		public VisualStudioSettingsPageArxNet(string key) : base(key)
		{
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(VisualStudioSettingsPageArxNet));
