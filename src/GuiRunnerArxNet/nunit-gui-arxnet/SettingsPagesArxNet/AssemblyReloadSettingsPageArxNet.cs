...
//  2013.5.30修改：
//      1.在nunit2.6.2基础上修改
//      2.NUnit.Gui.SettingsPages.AssemblyReloadSettingsPage改为NUnit.Gui.ArxNet.SettingsPagesArxNet.AssemblyReloadSettingsPageArxNet类
...
{
	public class AssemblyReloadSettingsPageArxNet : NUnit.UiKit.ArxNet.SettingsPageArxNet
	{
		...
		public AssemblyReloadSettingsPageArxNet(string key) : base(key)
		{
