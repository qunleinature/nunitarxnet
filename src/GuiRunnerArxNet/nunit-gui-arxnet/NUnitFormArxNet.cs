...
namespace NUnit.Gui.ArxNet
{
	...
	public class NUnitFormArxNet : NUnitFormBase
	{
		...
		private TestTreeArxNet testTree = null;
		...
		private bool IsProjectLoaded
		{
			get 
            {
                if (TestLoader == null) return false;//2013-1-11:NUnit.Gui.ArxNet.Tests.NUnitFormArxNetTests.ShowModalDialog测试加
		...
		private NUnitProject TestProject
		{
			get 
            {
                if (TestLoader == null) return null;//2013-1-11:NUnit.Gui.ArxNet.Tests.NUnitFormArxNetTests.ShowModalDialog测试加
		...
		{
            if (TestLoader == null) return;//2013-1-11:NUnit.Gui.ArxNet.Tests.NUnitFormArxNetTests.ShowModalDialog测试加
            if (TestProject == null) return;//2013-1-11:NUnit.Gui.ArxNet.Tests.NUnitFormArxNetTests.ShowModalDialog测试加
		...
		{
            if (fixedFont == null) return;//2013-1-11:NUnit.Gui.ArxNet.Tests.NUnitFormArxNetTests.ShowModalDialog测试加
		...
		private void NUnitFormArxNet_Load(object sender, System.EventArgs e)
		{
            if (!this.DesignMode)
            {
                try//2013-1-11:NUnit.Gui.ArxNet.Tests.NUnitFormArxNetTests.ShowModalDialog测试加
                {
                    if (recentFilesService == null) return;//2013-1-11:NUnit.Gui.ArxNet.Tests.NUnitFormArxNetTests.ShowModalDialog测试加
                    if (TestLoader == null) return;//2013-1-11:NUnit.Gui.ArxNet.Tests.NUnitFormArxNetTests.ShowModalDialog测试加                    
                ...
                /*2013-1-11:NUnit.Gui.ArxNet.Tests.NUnitFormArxNetTests.ShowModalDialog测试加*/
