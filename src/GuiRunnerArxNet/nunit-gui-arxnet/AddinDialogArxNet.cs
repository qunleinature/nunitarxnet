...
//  2013.6.1修改：
//      1.在nunit2.6.2基础上修改
//      2.NUnit.Gui.AddinDialog改为NUnit.Gui.ArxNet.AddinDialogArxNet类
...
namespace NUnit.Gui.ArxNet
{
	...
	/// </summary>
	public class AddinDialogArxNet : System.Windows.Forms.Form
	{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(AddinDialogArxNet));
		...
		private void AddinDialogArxNet_Load(object sender, System.EventArgs e)
		{
			this.addins = NUnit.Util.ArxNet.ServicesArxNet.AddinRegistry.Addins;
