...
// 2013.5.28修改：
//  1.在nunit2.6.2基础上修改
//  2.NUnit.UiKit.SettingsPage改为NUnit.UiKit.ArxNet.SettingsPageArxNet类
...
namespace NUnit.UiKit.ArxNet
{
	...
	/// </summary>
	public class SettingsPageArxNet : System.Windows.Forms.UserControl
	{
		/// <summary> 
		...
		// or TreeBased dialog.
		public SettingsPageArxNet( string key) : this()
		{
			this.key = key;
			this.title = key;
