...
namespace NUnit.UiKit.ArxNet
{
	...
	/// </summary>
	public class EditTabPagesDialogArxNet : NUnitFormBase
	{
		private TextDisplayTabSettingsArxNet tabSettings;
		...
		public EditTabPagesDialogArxNet(TextDisplayTabSettingsArxNet tabSettings)
		{
			//
		...
		private void FillListBox()
		{
			...
			foreach( TextDisplayTabSettingsArxNet.TabInfo tab in tabSettings.Tabs )
		...
		{
			TextDisplayTabSettingsArxNet.TabInfo tab = tabSettings.Tabs[selectedIndex];
			tabSettings.Tabs.RemoveAt(selectedIndex--);
