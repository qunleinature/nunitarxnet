...
// 2013.5.31修改：
//  1.在nunit2.6.2基础上修改
//  2.NUnit.UiKit.AddTabPageDialog改为NUnit.UiKit.ArxNet.AddTabPageDialogArxNet类
...
namespace NUnit.UiKit.ArxNet
{
	...
	/// </summary>
    public class AddTabPageDialogArxNet : NUnitFormBase
	{
		...
		public AddTabPageDialogArxNet(TextDisplayTabSettingsArxNet tabSettings)
		{
			//
