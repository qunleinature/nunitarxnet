...
namespace NUnit.UiKit.ArxNet
{
	...
	/// when that occurs.
	/// </summary>
	public class ColorProgressBarArxNet : System.Windows.Forms.Control
	{
	...
	public class TestProgressBarArxNet : ColorProgressBarArxNet, TestObserver
	{
