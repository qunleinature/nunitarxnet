...
// 2012.12.21ÐÞ¸Ä:¸ÄServicesÎªServicesArxNet
// 2013.1.8ÐÞ¸Ä£º
//  1.NUnit.Gui.ArxNet.Tests.NUnitFormArxNetTests.ShowModalDialog²âÊÔ¸Ä
// ****************************************************************
...
//			displayController.CreatePages();
		...
		protected override void OnLoad(EventArgs e)
		{
            if (!this.DesignMode)
            {
                try//2013-1-10:NUnit.Gui.ArxNet.Tests.NUnitFormArxNetTests.ShowModalDialog²âÊÔ¼Ó
                {
                    if (ServicesArxNet.TestLoader == null) return;//2013-1-10:NUnit.Gui.ArxNet.Tests.NUnitFormArxNetTests.ShowModalDialog²âÊÔ¼Ó
                ...
                /*2013-1-10:NUnit.Gui.ArxNet.Tests.NUnitFormArxNetTests.ShowModalDialog²âÊÔ¼Ó*/
		...
		{
            if (settings == null) return;//2013-1-11:NUnit.Gui.ArxNet.Tests.NUnitFormArxNetTests.ShowModalDialog²âÊÔ¼Ó
