...
//  2013.5.31修改：
//      1.在nunit2.6.2基础上修改
//      2.NUnit.UiKit.TestPropertiesDialog改为NUnit.UiKit.ArxNet.TestPropertiesDialogArxNet类
//      3.改TestSuiteTreeNode为TestSuiteTreeNodeArxNet
//  2015.2.9：
//      在NUnit2.6.4基础上修改
// ****************************************************************
...
{
    public partial class TestPropertiesDialogArxNet : Form
    {
        private TestSuiteTreeNodeArxNet node;
        private ITest test;
        ...
        public TestPropertiesDialogArxNet(TestSuiteTreeNodeArxNet node)
        {
            InitializeComponent();
        ...
        public void DisplayProperties(TestSuiteTreeNodeArxNet node)
        {
            this.node = node;
            this.test = node.Test;
        ...
        {
            pinnedImage = new Bitmap(typeof(TestPropertiesDialogArxNet), "Images.pinned.gif");
            unpinnedImage = new Bitmap(typeof(TestPropertiesDialogArxNet), "Images.unpinned.gif");
        ...
        private void OnSelectedNodeChanged(object sender, TreeViewEventArgs e)
        {
            if (pinButton.Checked)
            {
                DisplayProperties((TestSuiteTreeNodeArxNet)e.Node);
            }
            else
                this.Close();
        }
